...
(function () {
  function L(a) {
    ...
    function e(a) {
      switch (a.nodeType) {
        case 1:
          if (k.test(a.className)) break;if (a.nodeName === 'BR') {
            h(a), a.parentNode && a.parentNode.removeChild(a);
          } else for (a = a.firstChild; a; a = a.nextSibling) {
            e(a);
          }break;case 3:case 4:
          if (p) {
            var b = a.nodeValue,
      ...
      for (; !a.nextSibling;) {
        ...
        t = /\r\n?|\n/,
        s = a.ownerDocument,
        l;a.currentStyle ? l = a.currentStyle.whiteSpace : window.getComputedStyle && (l = s.defaultView.getComputedStyle(a, q).getPropertyValue('white-space'));var p = l && l.substring(0, 3) === 'pre';for (l = s.createElement('LI'); a.firstChild;) {
    ...
    var m = a.g;try {
      ...
      N = /\S/,
      O = u({ keywords: [F, H, w, 'caller,delete,die,do,dump,elsif,eval,exit,foreach,for,goto,if,import,last,local,my,next,no,our,print,package,redo,require,sub,undef,unless,until,use,wantarray,while,BEGIN,END' + I, J, v],
    hashComments: !0,
    cStyleComments: !0,
    multiLineStrings: !0,
    regexLiterals: !0 }),
